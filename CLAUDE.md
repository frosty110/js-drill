...
| `tools/validate-system-design.js` | Structural validator across all system-design topics (topics↔manifest↔disk parity, question/diagram/spec schema, and exact registered set of 36 valid 1600×2000 PNG infographics). |
