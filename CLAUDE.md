...
| `tools/validate-system-design.js` | Structural validator across all system-design topics (topics↔manifest↔disk parity, question/diagram/spec schema, complete 36-lesson infographic plan, authored set schema/count/order, and exact registered PNG paths/dimensions). |
