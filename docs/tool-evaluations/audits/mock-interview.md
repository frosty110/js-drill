...
**Anchor file:** `js/app/09-stats-cheatsheet-mock.js:670` (+ `js/app/12c-l3.js:572`)
**Scored:** 2026-05-30
...
|---|---|---|
| Active recall | 3/3 | Blank editor + hints/diff/reveal/critical-fill all gated off when `isMock` is true — `js/app/12c-l3.js:193-201` (`${isMock ? '' : ...}`) and `:358-361` (no cached editor text restored during mock). User must produce the canonical from memory; nothing to read or recognize. |
