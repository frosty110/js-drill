...
**Shipped from this category:** 🤖 AI Coach Export (iter 88) → see [`shipped-by-category.md` § 6](shipped-by-category.md#6-persistence--sync).
...
**Shipped from this category:** 🪲 Bug-Hunt (iter 73) · 🎯 Reverse problem-identification (iter 76) · 📐 Smell test complexity-claim (iter 79) · 🛡 Edge case pre-enumeration (iter 81) → see [`shipped-by-category.md` § 9](shipped-by-category.md#9-interview-conditioning).
